...
BUILDIN_CLASSIFIER = {
    'lvis': 'metadata/lvis_v1_clip_a+cname.npy',
...
class VisualizationDemo(object):
    def __init__(self, cfg, args, meta_dir, instance_mode=ColorMode.IMAGE, parallel=False):
        """
        Args:
            cfg (CfgNode):
        ...
        if args.vocabulary == 'custom':
            ...
            assert len(self.metadata.thing_classes) == 200
            classifier = get_clip_embeddings(self.metadata.thing_classes)
            ...
            classifier = os.path.join(self.meta_dir, BUILDIN_CLASSIFIER[args.vocabulary])
